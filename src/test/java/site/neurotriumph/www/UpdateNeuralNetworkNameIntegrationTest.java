...
public class UpdateNeuralNetworkNameIntegrationTest {
  private final String baseUrl = "/user/nn/name";
  ...
  public void shouldReturnNothingToUpdateError() throws Exception {
    ...
    this.mockMvc.perform(put(baseUrl)
        ...
        .content(objectMapper.writeValueAsString(updateNeuralNetworkNameRequestBody))
  ...
  public void shouldReturnNeuralNetworkDoesNotExist() throws Exception {
    ...
    for (Long invalidId : invalidIds) {
      updateNeuralNetworkNameRequestBody.setId(invalidId);
  ...
  public void shouldReturnInvalidNeuralNetworkNameError() throws Exception {
    ...
    for (String invalidName : invalidNames) {
      updateNeuralNetworkNameRequestBody.setNew_name(invalidName);
